...
**Official repository.** - `git clone https://github.com/coryhouse/pluralsight-redux-app-used-to-build-script.git` or [download the zip](https://github.com/coryhouse/pluralsight-redux-app-used-to-build-script/archive/master.zip)
